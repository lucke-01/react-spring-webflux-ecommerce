...
class UpdateCouponImplTest {
    ...
    @InjectMocks
    private UpdateCouponImpl updateCoupon;
    ...
    void should_update_coupon() {
        ...
        given(this.couponRepository.update(coupon)).willReturn(Mono.just(mockCoupon()));
        ...
        // When
        var response = this.updateCoupon.update(coupon, login).block();
        ...
        verify(this.couponRepository).update(any());
    }

    @Test
    void should_not_update_coupon_uniqueName() {
        //given
        String login = "login";
        ...
        // When
        var response = this.updateCoupon.update(request, login);
    ...
    @Test
    void should_not_update_coupon_uniqueCode() {
        //given
        String login = "login";
        Coupon request = mockCoupon();
        given(this.couponValidator.checkDuplicatedName(eq(COUPON_NAME), isNull())).willReturn(Mono.just(true));
